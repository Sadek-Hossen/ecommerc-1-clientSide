...
export default function ManageProducts() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get("https://68d41937c0bcff12629088dc--econnerce1-backend.netlify.app/api/product");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://68d41937c0bcff12629088dc--econnerce1-backend.netlify.app/api/product/delete-product/${id}`);
